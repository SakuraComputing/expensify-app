...
test('should render expense form with a data',() => {
...
// changes to amount invalid
// 12.122
test('should not set amount on invalid data change',() => {
   const value = '12.222';
   const wrapper = shallow(<ExpenseForm />);
   wrapper.find('input').at(1).simulate('change', {
      target: value
...
test('should set new data on focus change',() => {
    const focused = true;
    const wrapper = shallow(<ExpenseForm />);
